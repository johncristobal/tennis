        ...
        <tr>
            <td>
                <table style="border-spacing: 0; font-family:Helvetica,Arial,sans-serif;" width="100%">
                    <thead style="background-color: #724189; border-top-left-radius: 15px; color: white">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td width="45%" align="center">
                                <br>
                                <div style="height: 20px; background-color: #00aeef; width: 120px;padding: 5px; border-radius: 10px"><a href="<?php echo base_url()?>Torneos/confirmarPartido/<?= $idjugador ?>/<?= $value['idpartido'] ?>/<?= $value['id_rival'] ?>/7" style="text-decoration: none; color: white">Ahí estaré</a></div>
                                <br>
                                <div style="height: 20px; background-color: red; width: 120px;padding: 5px; border-radius: 10px"><a href="<?php echo base_url()?>Torneos/confirmarPartido/<?= $idjugador ?>/<?= $value['idpartido'] ?>/<?= $value['id_rival'] ?>/8" style="text-decoration: none; color: white;">No podré asistir</a></div> 
                            </td>
                        </tr>  
                        <?php } ?>
                    </tbody>
