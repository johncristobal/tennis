          ...
          <div class="panel panel-default">
            ...
            <div id="collapse<?=$row->id;?>" class="panel-collapse collapse in">
              ...
              <div class="panel-body"><!--Colocar datos importantes del torneo-->                  
                ...
                <section class="row">
                <div class="col-md-3">
                    <a href="<?php echo base_url();?>admin/resultados/<?=$row->id;?>"><h4 class="title-green"><?=$row->nombre;?></h4></a>
                    <p><?=$row->lugar;?></p>
           ...
           <?php            
            ...
            <div class="modal-footer centered">
                <a href="<?php echo base_url();?>admin/registrotorneo" type="button" class="btn btn-info btn-lg" data-dismiss="modal">Clic aquí</a>                
            </div>
            </div>
            <?php
            }
